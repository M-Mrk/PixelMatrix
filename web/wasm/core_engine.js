...
if (Symbol.dispose) Pixel.prototype[Symbol.dispose] = Pixel.prototype.free;

/**
 * @enum {0}
 */
export const ScriptType = Object.freeze({
    Rhai: 0, "0": "Rhai",
});

/**
 * @param {string} script
 * @param {ScriptType} script_type
 * @param {bigint} resolution_width
 * @param {bigint} resolution_height
 * @returns {Pixel[]}
 */
export function run_script(script, script_type, resolution_width, resolution_height) {
